...
useEffect(() => {
 const Article = async () => {
  const response = await axios.get("https://newsapi.org/v2/top-headlines?country=us&apiKey=48038233fbf342cda63c50616809c30a&page=2")
    ...
    return(
      ...
      <div className='rounded overflow-hidden shadow-lg max-w-sm bg-white'>
        ...
        <div className='px-6 py-4'>
          <div className='font-bold text-xl mb-2'> {article.title.slice(0,40)} ...</div>
